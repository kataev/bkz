...
//
dojo.declare("whs.BrickSelectWidget", [dijit.form.TextBox], {
//            label:'Loading...',
            templateString:
...
//                var a = this;
//                dojo.when(brick.get(value), function(data){
//                    var b = data[0].fields;
//                    var label='';
...
//                return 'Loading';
            ...
            parse: function(/*String*/ value, /*Object*/ constraints) {
                ...
                // tags:
                //		protected extension
//                var a = dojo.create('span',{innerHTML:value})
//                console.log(dojo.attr(a.childNodes[0],'value'));
                return value;
//                return dojo.attr(a.childNodes[0],'value');	// String
            }
//            resize: function(){},
//            postCreate: function() {
//
...
//		placeHolder: "",
//
//		templateString: dojo.cache("whs.BrickSelectWidget", "templates/BrickSelectWidget.html"),
