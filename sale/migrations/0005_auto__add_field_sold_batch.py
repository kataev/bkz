...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sold.batch'
        db.add_column('sale_sold', 'batch',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Sold.batch'
        db.delete_column('sale_sold', 'batch')
    ...
    models = {
        ...
        'sale.bill': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 4, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'sale.sold': {
            ...
            'amount': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'batch': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
