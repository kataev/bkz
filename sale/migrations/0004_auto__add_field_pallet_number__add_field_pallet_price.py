...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pallet.number'
        db.add_column('sale_pallet', 'number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Pallet.price'
        db.add_column('sale_pallet', 'price',
                      self.gf('django.db.models.fields.FloatField')(default=200),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Pallet.number'
        db.delete_column('sale_pallet', 'number')

        # Deleting field 'Pallet.price'
        db.delete_column('sale_pallet', 'price')
