...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sold.batch_from'
        db.add_column('sale_sold', 'batch_from',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=600, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Sold.batch_from'
        db.delete_column('sale_sold', 'batch_from')
    ...
    models = {
        ...
        'sale.bill': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
