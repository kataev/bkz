...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('bill_bill', 'money')


    def backwards(self, orm):
        
        # Adding field 'Bill.money'
        db.add_column('bill_bill', 'money', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
