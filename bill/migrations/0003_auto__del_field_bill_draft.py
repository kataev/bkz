...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Bill.draft'
        db.delete_column('bill_bill', 'draft')


    def backwards(self, orm):
        
        # Adding field 'Bill.draft'
        db.add_column('bill_bill', 'draft', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
