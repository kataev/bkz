...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Width.tto'
        db.add_column('whs_width', 'tto',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Width.tto'
        db.delete_column('whs_width', 'tto')
    ...
    models = {
        ...
        'whs.bill': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 15, 0, 0)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'whs.seller': {
            ...
            'agent': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['whs.Agent']", 'unique': 'True'}),
