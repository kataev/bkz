...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Width.tts'
        db.add_column('whs_width', 'tts',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Width.tts'
        db.delete_column('whs_width', 'tts')
    ...
    models = {
        ...
        'whs.bill': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 13, 0, 0)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
