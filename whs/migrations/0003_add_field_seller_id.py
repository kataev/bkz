...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute('alter TABLE whs_seller drop CONSTRAINT whs_seller_pkey cascade')
        db.execute('alter TABLE whs_seller add column "id" serial NOT NULL PRIMARY KEY;')
        db.rename_column('whs_seller','agent_ptr_id','agent_id')
        

    def backwards(self, orm):
        # Deleting field 'Seller.id'
        db.delete_column('whs_seller', 'id')
