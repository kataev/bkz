...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Half.tts'
        db.execute('ALTER TABLE "lab_half" ALTER COLUMN "tts" TYPE integer USING tts::integer, ALTER COLUMN "tts" SET NOT NULL, ALTER COLUMN "tts" DROP DEFAULT;')
        # db.alter_column('lab_half', 'tts', self.gf('django.db.models.fields.IntegerField')(max_length=20))

        # Changing field 'Bar.tts'
        db.execute('ALTER TABLE "lab_bar" ALTER COLUMN "tts" TYPE integer USING tts::integer, ALTER COLUMN "tts" SET NOT NULL, ALTER COLUMN "tts" DROP DEFAULT;')
        # db.alter_column('lab_bar', 'tts', self.gf('django.db.models.fields.IntegerField')(max_length=20))

        # Changing field 'Bar.temperature'
        db.execute('ALTER TABLE "lab_bar" ALTER COLUMN "tts" TYPE integer USING tts::integer, ALTER COLUMN "tts" SET NOT NULL, ALTER COLUMN "tts" DROP DEFAULT;')
        # db.alter_column('lab_bar', 'temperature', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Raw.temperature'
        db.execute('ALTER TABLE "lab_raw" ALTER COLUMN "tts" TYPE integer USING tts::integer, ALTER COLUMN "tts" SET NOT NULL, ALTER COLUMN "tts" DROP DEFAULT;')
        # db.alter_column('lab_raw', 'temperature', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Raw.tts'
        db.execute('ALTER TABLE "lab_raw" ALTER COLUMN "tts" TYPE integer USING tts::integer, ALTER COLUMN "tts" SET NOT NULL, ALTER COLUMN "tts" DROP DEFAULT;')
        # db.alter_column('lab_raw', 'tts', self.gf('django.db.models.fields.IntegerField')(max_length=20))
    def backwards(self, orm):

        # Changing field 'Half.tts'
        db.alter_column('lab_half', 'tts', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Bar.tts'
        db.alter_column('lab_bar', 'tts', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Bar.temperature'
        db.alter_column('lab_bar', 'temperature', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Raw.temperature'
        db.alter_column('lab_raw', 'temperature', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Raw.tts'
        db.alter_column('lab_raw', 'tts', self.gf('django.db.models.fields.CharField')(max_length=20))
    models = {
        'lab.bar': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 4, 0, 0)'}),
        ...
        'lab.batch': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 4, 0, 0)'}),
