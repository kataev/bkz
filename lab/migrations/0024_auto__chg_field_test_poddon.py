...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Test.poddon'
        db.alter_column('lab_test', 'poddon', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=10))
    def backwards(self, orm):

        # Changing field 'Test.poddon'
        db.alter_column('lab_test', 'poddon', self.gf('django.db.models.fields.IntegerField')())
    models = {
        'lab.bar': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 1, 0, 0)'}),
        ...
        'lab.test': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'poddon': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'default': '0', 'max_length': '10'}),
