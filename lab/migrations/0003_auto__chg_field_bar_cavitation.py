...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bar.cavitation'
        db.alter_column('lab_bar', 'cavitation', self.gf('django.db.models.fields.IntegerField')())
    def backwards(self, orm):

        # Changing field 'Bar.cavitation'
        db.alter_column('lab_bar', 'cavitation', self.gf('django.db.models.fields.PositiveIntegerField')())
    models = {
        'lab.bar': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 8, 0, 0)'}),
