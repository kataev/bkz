...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cause.type'
        db.add_column('lab_cause', 'type',
                      self.gf('django.db.models.fields.CharField')(default='part', max_length=30),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Cause.type'
        db.delete_column('lab_cause', 'type')
