...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Half.forming'
        db.add_column('lab_half', 'forming',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='halfs', null=True, to=orm['make.Forming']),
                      keep_default=False)

        # Adding field 'Bar.forming'
        db.add_column('lab_bar', 'forming',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bars', null=True, to=orm['make.Forming']),
                      keep_default=False)

        # Adding field 'Raw.forming'
        db.add_column('lab_raw', 'forming',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='raws', null=True, to=orm['make.Forming']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Half.forming'
        db.delete_column('lab_half', 'forming_id')

        # Deleting field 'Bar.forming'
        db.delete_column('lab_bar', 'forming_id')

        # Deleting field 'Raw.forming'
        db.delete_column('lab_raw', 'forming_id')
    ...
    models = {
        'lab.bar': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 18, 0, 0)'}),
