...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Batch.chamfer'
        db.alter_column('lab_batch', 'chamfer', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Batch.mark'
        db.alter_column('lab_batch', 'mark', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Batch.amount'
        db.alter_column('lab_batch', 'amount', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Batch.tto'
        db.alter_column('lab_batch', 'tto', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Batch.pressure'
        db.alter_column('lab_batch', 'pressure', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Batch.flexion'
        db.alter_column('lab_batch', 'flexion', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Part.cause'
        db.alter_column('lab_part', 'cause', self.gf('django.db.models.fields.TextField')(max_length=600))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Batch.chamfer'
        raise RuntimeError("Cannot reverse this migration. 'Batch.chamfer' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Batch.mark'
        raise RuntimeError("Cannot reverse this migration. 'Batch.mark' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Batch.amount'
        raise RuntimeError("Cannot reverse this migration. 'Batch.amount' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Batch.tto'
        raise RuntimeError("Cannot reverse this migration. 'Batch.tto' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Batch.pressure'
        raise RuntimeError("Cannot reverse this migration. 'Batch.pressure' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Batch.flexion'
        raise RuntimeError("Cannot reverse this migration. 'Batch.flexion' and its values cannot be restored.")

        # Changing field 'Part.cause'
        db.alter_column('lab_part', 'cause', self.gf('django.db.models.fields.IntegerField')())
    models = {
        'lab.bar': {
            'Meta': {'object_name': 'Bar'},
            'cutter': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '3000'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 23, 13, 41, 58)'}),
