...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Batch.density'
        db.add_column('lab_batch', 'density',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Batch.density'
        db.delete_column('lab_batch', 'density')

    models = {
        'lab.bar': {
            'Meta': {'object_name': 'Bar'},
            'cutter': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '3000'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 8, 16, 12, 5, 2)'}),
