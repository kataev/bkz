...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pressure.ares'
        db.add_column('lab_pressure', 'ares',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Flexion.readings'
        db.add_column('lab_flexion', 'readings',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Flexion.ares'
        db.add_column('lab_flexion', 'ares',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Flexion.readings'
        db.delete_column('lab_flexion', 'readings')
    ...
    models = {
        'lab.bar': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 20, 14, 43, 32, 4)'}),
        ...
        'lab.flexion': {
            ...
            'ares': ('django.db.models.fields.FloatField', [], {}),
