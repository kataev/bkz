...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Half.order'
        db.add_column('lab_half', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Bar.order'
        db.add_column('lab_bar', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Matherial.order'
        db.add_column('lab_matherial', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Raw.order'
        db.add_column('lab_raw', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Half.order'
        db.delete_column('lab_half', 'order')

        # Deleting field 'Bar.order'
        db.delete_column('lab_bar', 'order')

        # Deleting field 'Matherial.order'
        db.delete_column('lab_matherial', 'order')

        # Deleting field 'Raw.order'
        db.delete_column('lab_raw', 'order')
    ...
    models = {
        'lab.bar': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 11, 0, 0)'}),
        ...
        'lab.batch': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 11, 0, 0)'}),
