...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Half.weight'
        db.alter_column('lab_half', 'weight', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Bar.weight'
        db.alter_column('lab_bar', 'weight', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Batch.weight'
        db.alter_column('lab_batch', 'weight', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Raw.weight'
        db.alter_column('lab_raw', 'weight', self.gf('django.db.models.fields.IntegerField')())
    def backwards(self, orm):

        # Changing field 'Half.weight'
        db.alter_column('lab_half', 'weight', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Bar.weight'
        db.alter_column('lab_bar', 'weight', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Batch.weight'
        db.alter_column('lab_batch', 'weight', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Raw.weight'
        db.alter_column('lab_raw', 'weight', self.gf('django.db.models.fields.FloatField')())
    models = {
        'lab.bar': {
        ...
        'lab.matherial': {
            'Meta': {'ordering': "('datetime', '-position')", 'object_name': 'Matherial'},
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 1, 0, 0)'}),
