...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FrostResistance.mark'
        db.add_column('lab_frostresistance', 'mark',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=100),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FrostResistance.mark'
        db.delete_column('lab_frostresistance', 'mark')

    models = {
        'lab.bar': {
            'Meta': {'object_name': 'Bar'},
            'cutter': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '3000'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 9, 10, 57, 18, 3)'}),
