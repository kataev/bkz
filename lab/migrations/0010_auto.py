...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field cause on 'Half'
        db.create_table('lab_half_cause', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('half', models.ForeignKey(orm['lab.half'], null=False)),
            ('cause', models.ForeignKey(orm['lab.cause'], null=False))
        ))
        db.create_unique('lab_half_cause', ['half_id', 'cause_id'])

    def backwards(self, orm):
        # Removing M2M table for field cause on 'Half'
        db.delete_table('lab_half_cause')
