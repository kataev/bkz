...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Batch.inclusion'
        db.delete_column('lab_batch', 'inclusion')

    def backwards(self, orm):
        # Adding field 'Batch.inclusion'
        db.add_column('lab_batch', 'inclusion',
    ...
    models = {
        'lab.bar': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 24, 10, 26, 41, 1)'}),
        ...
        'lab.batch': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 24, 0, 0)'}),
