...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Bar.humidity_transporter'
        db.delete_column('lab_bar', 'humidity_transporter')

    def backwards(self, orm):
        # Adding field 'Bar.humidity_transporter'
        db.add_column('lab_bar', 'humidity_transporter',
