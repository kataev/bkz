...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Part.brocken'
        db.add_column('lab_part', 'brocken',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Part.brocken'
        db.delete_column('lab_part', 'brocken')

    models = {
        'lab.bar': {
            'Meta': {'object_name': 'Bar'},
            'cutter': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '3000'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 23, 10, 44, 1)'}),
