...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pressure.readings'
        db.add_column('lab_pressure', 'readings',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Pressure.readings'
        db.delete_column('lab_pressure', 'readings')

    models = {
        'lab.bar': {
            'Meta': {'object_name': 'Bar'},
            'cutter': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '3000'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 19, 14, 33, 10, 3)'}),
