...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Batch.efflorescence'
        db.delete_column('lab_batch', 'efflorescence_id')

        # Adding field 'Batch.weight'
        db.add_column('lab_batch', 'weight',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Batch.efflorescence'
        db.add_column('lab_batch', 'efflorescence',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.Efflorescence'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Batch.weight'
        db.delete_column('lab_batch', 'weight')

    models = {
        'lab.bar': {
            'Meta': {'object_name': 'Bar'},
            'cutter': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '3000'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 9, 11, 6, 49, 3)'}),
