...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cause.code'
        db.alter_column('lab_cause', 'code', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Cause.code'
        raise RuntimeError("Cannot reverse this migration. 'Cause.code' and its values cannot be restored.")
    models = {
        'lab.bar': {
