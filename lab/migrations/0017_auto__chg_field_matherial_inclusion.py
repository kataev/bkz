...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Matherial.inclusion'
        db.alter_column('lab_matherial', 'inclusion', self.gf('django.db.models.fields.TextField')(null=True))
    def backwards(self, orm):

        # Changing field 'Matherial.inclusion'
        db.alter_column('lab_matherial', 'inclusion', self.gf('django.db.models.fields.FloatField')(null=True))
    models = {
        'lab.bar': {
