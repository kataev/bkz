...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Batch.heatconduction'
        db.alter_column('lab_batch', 'heatconduction_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.HeatConduction'], null=True))

        # Changing field 'Batch.seonr'
        db.alter_column('lab_batch', 'seonr_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.SEONR'], null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Batch.heatconduction'
        raise RuntimeError("Cannot reverse this migration. 'Batch.heatconduction' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Batch.seonr'
        raise RuntimeError("Cannot reverse this migration. 'Batch.seonr' and its values cannot be restored.")
    models = {
        'lab.bar': {
            'Meta': {'object_name': 'Bar'},
            'cutter': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '3000'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 8, 16, 1, 34, 2)'}),
        ...
        'lab.batch': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 8, 0, 0)'}),
