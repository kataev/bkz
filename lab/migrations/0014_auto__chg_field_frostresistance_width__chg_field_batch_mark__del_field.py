...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FrostResistance.width'
        db.alter_column('lab_frostresistance', 'width', self.gf('django.db.models.fields.FloatField')(max_length=30))

        # Changing field 'Batch.mark'
        db.alter_column('lab_batch', 'mark', self.gf('django.db.models.fields.PositiveIntegerField')(default=100))
        # Deleting field 'HeatConduction.color'
        db.delete_column('lab_heatconduction', 'color')


        # Changing field 'HeatConduction.width'
        db.alter_column('lab_heatconduction', 'width', self.gf('django.db.models.fields.FloatField')(max_length=30))

        # Changing field 'Density.width'
        db.alter_column('lab_density', 'width', self.gf('django.db.models.fields.FloatField')(max_length=30))

        # Changing field 'WaterAbsorption.width'
        db.alter_column('lab_waterabsorption', 'width', self.gf('django.db.models.fields.FloatField')(max_length=30))
    def backwards(self, orm):

        # Changing field 'FrostResistance.width'
        db.alter_column('lab_frostresistance', 'width', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Batch.mark'
        db.alter_column('lab_batch', 'mark', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # User chose to not deal with backwards NULL issues for 'HeatConduction.color'

        # Changing field 'HeatConduction.width'
        db.alter_column('lab_heatconduction', 'width', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Density.width'
        db.alter_column('lab_density', 'width', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'WaterAbsorption.width'
        db.alter_column('lab_waterabsorption', 'width', self.gf('django.db.models.fields.FloatField')())
    models = {
        'lab.bar': {
            'Meta': {'object_name': 'Bar'},
            'cutter': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '3000'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 9, 10, 49, 26, 3)'}),
