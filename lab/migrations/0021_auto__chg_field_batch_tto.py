...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lab_batch', 'tto', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=80, null=True))
    ...
    models = {
        'lab.bar': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 0, 0)'}),
