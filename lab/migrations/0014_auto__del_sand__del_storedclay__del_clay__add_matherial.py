...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Matherial'
        db.create_table('lab_matherial', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 1, 0, 0))),
            ...
            ('inclusion', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('dust', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('particle_size', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('module_size', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('dirt', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('info', self.gf('django.db.models.fields.TextField')(max_length=3000, null=True, blank=True)),
        ))
        db.send_create_signal('lab', ['Matherial'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Matherial'
        db.delete_table('lab_matherial')
