...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bar.weight'
        db.alter_column('lab_bar', 'weight', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Bar.sand'
        db.alter_column('lab_bar', 'sand', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Bar.size'
        db.alter_column('lab_bar', 'size', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Bar.temperature'
        db.alter_column('lab_bar', 'temperature', self.gf('django.db.models.fields.FloatField')(null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Bar.weight'
        raise RuntimeError("Cannot reverse this migration. 'Bar.weight' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Bar.sand'
        raise RuntimeError("Cannot reverse this migration. 'Bar.sand' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Bar.size'
        raise RuntimeError("Cannot reverse this migration. 'Bar.size' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Bar.temperature'
        raise RuntimeError("Cannot reverse this migration. 'Bar.temperature' and its values cannot be restored.")
    models = {
        'lab.bar': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 1, 0, 0)'}),
            'forming': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'bars'", 'null': 'True', 'to': "orm['make.TTS']"}),
        ...
        'lab.half': {
            ...
            'color': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 1, 0, 0)'}),
            'forming': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'halfs'", 'null': 'True', 'to': "orm['make.TTS']"}),
            'humidity': ('django.db.models.fields.FloatField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info': ('django.db.models.fields.TextField', [], {'max_length': '3000', 'null': 'True', 'blank': 'True'}),
        ...
        'lab.raw': {
            ...
            'color': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 1, 0, 0)'}),
            'forming': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'raws'", 'null': 'True', 'to': "orm['make.TTS']"}),
            'humidity': ('django.db.models.fields.FloatField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info': ('django.db.models.fields.TextField', [], {'max_length': '3000', 'null': 'True', 'blank': 'True'}),
            'size': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
        ...
        'make.tts': {
            'Meta': {'object_name': 'TTS'},
            'forming': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tts'", 'null': 'True', 'to': "orm['make.Forming']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
