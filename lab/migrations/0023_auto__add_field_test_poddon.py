...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Test.poddon'
        db.add_column('lab_test', 'poddon',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Test.poddon'
        db.delete_column('lab_test', 'poddon')
    ...
    models = {
        'lab.bar': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 15, 0, 0)'}),
