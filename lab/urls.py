...
urlpatterns = patterns('bkz.lab.views',
                       ...
                       url(ur'^Показатели/$', 'stats', name='stats'),
                       ...
                       url(ur'^ГотоваяПродукция/(?P<pk>\d+)/печать_документа_о_качестве$', 'batch_print_doc',
                           name='Batch-print_doc'),
                       url(ur'^ГотоваяПродукция/(?P<pk>\d+)/испытания$', 'batch_tests', name='Batch-tests'),
                       url(ur'^ГотоваяПродукция/(?P<pk>\d+)/испытания/печать_протокола$', 'batch_tests_print',
                           name='Batch-tests_print'),
)
