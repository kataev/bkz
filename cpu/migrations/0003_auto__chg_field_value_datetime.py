...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Value.datetime'
        db.alter_column('cpu_value', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    def backwards(self, orm):

        # Changing field 'Value.datetime'
        db.alter_column('cpu_value', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    models = {
        'cpu.device': {
