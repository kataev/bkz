...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Forming.order'
        db.add_column('make_forming', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Forming.order'
        db.delete_column('make_forming', 'order')
    ...
    models = {
        'lab.batch': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 6, 0, 0)'}),
        ...
        'make.warren': {
            ...
            'cause': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['lab.Cause']", 'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 6, 0, 0)', 'null': 'True', 'blank': 'True'}),
