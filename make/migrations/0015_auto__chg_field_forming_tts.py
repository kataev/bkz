...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Forming.tts'
        db.execute('ALTER TABLE "make_forming" ALTER COLUMN "tts" TYPE integer USING tts::integer, ALTER COLUMN "tts" SET NOT NULL, ALTER COLUMN "tts" DROP DEFAULT;')

    def backwards(self, orm):

        # Changing field 'Forming.tts'
        db.alter_column('make_forming', 'tts', self.gf('django.db.models.fields.CharField')(max_length=20))
    models = {
        'lab.batch': {
        ...
        'make.warren': {
            ...
            'cause': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['lab.Cause']", 'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 4, 0, 0)', 'null': 'True', 'blank': 'True'}),
