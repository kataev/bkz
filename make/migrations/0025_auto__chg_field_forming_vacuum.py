...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Forming.vacuum'
        db.alter_column('make_forming', 'vacuum', self.gf('django.db.models.fields.FloatField')(null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Forming.vacuum'
        raise RuntimeError("Cannot reverse this migration. 'Forming.vacuum' and its values cannot be restored.")
    models = {
        'lab.batch': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 19, 0, 0)'}),
        ...
        'lab.test': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'poddon': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'make.forming': {
            ...
            'vacuum': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'width': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['whs.Width']"})
        },
        'make.warren': {
            ...
            'brocken': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'cause': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['lab.Cause']", 'null': 'True', 'blank': 'True'}),
        ...
        'whs.width': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'size': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'tto': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'tts': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
