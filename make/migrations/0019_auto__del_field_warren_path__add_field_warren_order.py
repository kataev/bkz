...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Warren.order'
        db.add_column('make_warren', 'order',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Warren.order'
        db.delete_column('make_warren', 'order')
    ...
    models = {
        'lab.batch': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 7, 0, 0)'}),
        ...
        'make.forming': {
            ...
            'cavitation': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'color': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'conveyor': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 7, 0, 0)'}),
