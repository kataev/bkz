...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Warren.number'
        db.delete_column('make_warren', 'number')

        # Adding field 'Warren.tto'
        db.add_column('make_warren', 'tto',
        ...
        # Adding field 'Warren.add'
        db.add_column('make_warren', 'add',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Warren.number'
        raise RuntimeError("Cannot reverse this migration. 'Warren.number' and its values cannot be restored.")
        # Deleting field 'Warren.tto'
        db.delete_column('make_warren', 'tto')

        # Deleting field 'Warren.tts'
        db.delete_column('make_warren', 'tts')

        # Deleting field 'Warren.add'
        db.delete_column('make_warren', 'add')
    ...
    models = {
        ...
        'make.warren': {
            ...
            'add': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'tto': ('django.db.models.fields.IntegerField', [], {}),
            'tts': ('django.db.models.fields.IntegerField', [], {})
        },
        'whs.brick': {
