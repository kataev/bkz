...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('make_tts', (
            ...
            ('forming', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tts', null=True, to=orm['make.Forming'])),
        ))
        ...
        db.add_column('make_warren', 'tts',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='warrens', null=True, to=orm['make.TTS']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Forming.tts'
        raise RuntimeError("Cannot reverse this migration. 'Forming.tts' and its values cannot be restored.")
    models = {
        'lab.batch': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 18, 0, 0)'}),
        ...
        'make.warren': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'tts': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'warrens'", 'null': 'True', 'to': "orm['make.TTS']"})
        },
        'whs.brick': {
