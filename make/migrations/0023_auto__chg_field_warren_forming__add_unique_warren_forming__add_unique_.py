...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Warren.forming'
        #db.alter_column('make_warren', 'forming_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['make.Forming'], unique=True, null=True))
        # Adding unique constraint on 'Warren', fields ['forming']
        db.create_unique('make_warren', ['forming_id'])

        # Adding unique constraint on 'Warren', fields ['date', 'tts']
        db.create_unique('make_warren', ['date', 'tts'])

        # Adding field 'Forming.empty'
        db.add_column('make_forming', 'empty',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Removing unique constraint on 'Warren', fields ['date', 'tts']
        db.delete_unique('make_warren', ['date', 'tts'])

        # Removing unique constraint on 'Warren', fields ['forming']
        db.delete_unique('make_warren', ['forming_id'])


        # Changing field 'Warren.forming'
        #db.alter_column('make_warren', 'forming_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['make.Forming']))
        # Deleting field 'Forming.empty'
        db.delete_column('make_forming', 'empty')
    ...
    models = {
        'lab.batch': {
            ...
            'tto': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
        ...
        'make.warren': {
            'Meta': {'ordering': "('-date', 'order')", 'unique_together': "(('date', 'tts'),)", 'object_name': 'Warren'},
            ...
            'forming': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['make.Forming']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
