...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute('UPDATE make_forming SET temperature = (temperature::integer);')
        db.alter_column('make_forming', 'temperature', self.gf('django.db.models.fields.IntegerField')(null=True))
