...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Warren.part'
        db.add_column('make_warren', 'part',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='warrens', null=True, to=orm['lab.Part']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Warren.part'
        db.delete_column('make_warren', 'part_id')
