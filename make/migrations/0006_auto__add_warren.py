...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('make_warren', (
            ...
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 3, 0, 0), null=True, blank=True)),
            ...
            ('tts', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='warrens', null=True, to=orm['make.Forming'])),
            ('part', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='warrens', null=True, to=orm['lab.Part'])),
        ))
    ...
    models = {
        ...
        'make.warren': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'tts': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'warrens'", 'null': 'True', 'to': "orm['make.Forming']"})
        },
        'whs.brick': {
