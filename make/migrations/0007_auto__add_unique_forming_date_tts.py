...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Forming', fields ['date', 'tts']
        db.create_unique('make_forming', ['date', 'tts'])

    def backwards(self, orm):
        # Removing unique constraint on 'Forming', fields ['date', 'tts']
        db.delete_unique('make_forming', ['date', 'tts'])
