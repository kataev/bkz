...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Warren.path'
        db.alter_column('make_warren', 'path', self.gf('django.db.models.fields.IntegerField')(null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Warren.path'
        raise RuntimeError("Cannot reverse this migration. 'Warren.path' and its values cannot be restored.")
    models = {
        'lab.batch': {
