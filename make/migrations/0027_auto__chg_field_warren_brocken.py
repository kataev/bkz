...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Warren.brocken'
        db.alter_column('make_warren', 'brocken', self.gf('bkz.make.fields.BrockenCharField')(max_length=10, null=True))
    def backwards(self, orm):

        # Changing field 'Warren.brocken'
        db.alter_column('make_warren', 'brocken', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    models = {
        'lab.batch': {
        ...
        'make.warren': {
            ...
            'brocken': ('bkz.make.fields.BrockenCharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'cause': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['lab.Cause']", 'null': 'True', 'blank': 'True'}),
            ...
            'path': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
