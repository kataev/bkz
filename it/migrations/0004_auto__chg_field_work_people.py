...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Work.people'
        db.alter_column('it_work', 'people_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Work.people'
        raise RuntimeError("Cannot reverse this migration. 'Work.people' and its values cannot be restored.")
    models = {
        'auth.group': {
