...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Plug.cartrige'
        db.delete_column('it_plug', 'cartrige_id')

        # Adding field 'Plug.cartridge'
        db.add_column('it_plug', 'cartridge',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'catridge', to=orm['it.Device']),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Plug.cartrige'
        raise RuntimeError("Cannot reverse this migration. 'Plug.cartrige' and its values cannot be restored.")
        # Deleting field 'Plug.cartridge'
        db.delete_column('it_plug', 'cartridge_id')
    ...
    models = {
        ...
        'it.plug': {
            ...
            'cartridge': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'catridge'", 'to': "orm['it.Device']"}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
