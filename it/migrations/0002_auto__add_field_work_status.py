...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Work.status'
        db.add_column('it_work', 'status',
                      self.gf('django.db.models.fields.CharField')(default=u'created', max_length=300),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Work.status'
        db.delete_column('it_work', 'status')
    ...
    models = {
        ...
        'it.device': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['it.Device']"})
        },
        'it.work': {
