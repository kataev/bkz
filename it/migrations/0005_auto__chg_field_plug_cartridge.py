...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Plug.cartridge'
        db.alter_column('it_plug', 'cartridge_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['it.Buy']))
    def backwards(self, orm):

        # Changing field 'Plug.cartridge'
        db.alter_column('it_plug', 'cartridge_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['it.Device']))
    models = {
        'auth.group': {
        ...
        'it.plug': {
            ...
            'cartridge': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'catridge'", 'to': "orm['it.Buy']"}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
