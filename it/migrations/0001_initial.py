...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('it_buy', (
            ...
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 8, 1, 0, 0))),
        ...
        db.create_table('it_plug', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cartridge', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'plug', to=orm['it.Buy'])),
    ...
    models = {
        ...
        'it.buy': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 1, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info': ('django.db.models.fields.CharField', [], {'max_length': '600', 'blank': 'True'}),
            'price': ('django.db.models.fields.FloatField', [], {})
        },
        'it.device': {
            'Meta': {'ordering': "('type__name',)", 'object_name': 'Device'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info': ('django.db.models.fields.CharField', [], {'max_length': '600', 'blank': 'True'}),
        ...
        'it.plug': {
            ...
            'cartridge': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'plug'", 'to': "orm['it.Buy']"}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 1, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
